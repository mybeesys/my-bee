...
| **أوامر التوريد** | ✅ API جاهز — شاشة الموبايل **جديدة تُبنى من الصفر** | CRUD + مشاركة + تحويل لمشتريات عبر prefill — انظر `docs/supply-orders-api-spec.md` |
...
DELETE /api/v1/tenant/shop/price-offers/{id}
