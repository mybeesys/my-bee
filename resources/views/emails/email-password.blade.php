    ...
    <tbody><tr><td style="text-align: center;">
        ...
        <td>
            <table border="0" cellpadding="0" cellspacing="0" style="text-align:center;width:100%;background-color: #fff;">
                ...
                <tr>
                    <td>
                        <h1 style="padding-top:25px;">Your password:</h1>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <a href="https://cp.nourappglobal.com" style="display:block;text-decoration:none;width:auto;width:150px;margin:10px auto;border-radius:4px;padding:10px 20px;border: 0;color:#fff;background-color:#009988; ">
                            Visit dashboard
                        </a>
                    </td>
                </tr>
