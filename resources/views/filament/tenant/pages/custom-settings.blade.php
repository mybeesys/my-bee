            ...
            <div class="container px-4 md:px-6">
                <div class="space-y-6">
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 custom-cols-6 gap-6">
                        ...
                        @include('filament.pages.settings-item', ['url' => \App\Filament\Tenant\Pages\InvConfig::getUrl(), 'title' => __('fields.currency_and_invoices'), 'icon' => "heroicon-o-document-text"])
