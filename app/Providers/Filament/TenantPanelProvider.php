...
//            ->passwordReset()
            ...
            ->renderHook(
                ...
                fn (): string => '<style id="tenant-notification-badge-style">'
                    ...
                    .'font-size:1rem!important;font-weight:900!important;box-shadow:none!important;min-width:0!important;min-height:0!important;padding:0!important;}'
                    .'.fi-panel-tenant .fi-topbar-database-notifications-btn .fi-icon-btn-badge-ctn:empty{display:none!important;}'
                    .'</style>'
