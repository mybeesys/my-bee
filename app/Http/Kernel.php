...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'restrict_requests_by_cors' => \App\Http\Middleware\RestrictRequestsByCors::class,
        'restrict_requests_by_roles' => \App\Http\Middleware\RestrictRequestsByRoles::class,
        'force_json_response' => \App\Http\Middleware\ForceJsonResponse::class,
        'ensure_tenant_id_in_header' => \App\Http\Middleware\EnsureTenantIdInHeader::class,
        'ensure_user_can_access_tenant' => \App\Http\Middleware\EnsureUserCanAccessTenant::class,
