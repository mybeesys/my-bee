...
class StorePurchasesReturnsRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            'returnMode' => ['sometimes', 'in:invoice,supplier'],
            'return_mode' => ['sometimes', 'in:invoice,supplier'],
        ...
        if ($returnMode === 'supplier') {
            $rules['supplierId'] = ['required_without:supplier_id', 'integer', 'exists:suppliers,id'];
            $rules['supplier_id'] = ['required_without:supplierId', 'integer', 'exists:suppliers,id'];
