...
class StorePaymentVoucherRequest extends BaseRequest
{
    ...
    public function isSupplierAllocation(): bool
    {
        return $this->input('for') === 'supplier' && $this->has('paid_amount');
    }
    ...
    {
        $allocation = $this->isSupplierAllocation();
        ...
        return [
            ...
            'credit_acc4_code' => ['sometimes', 'exists:acc4,code'],
            ...
            'invoice_id' => [Rule::requiredIf(! $allocation && $this->input('for') === 'supplier'), 'nullable', 'integer', 'exists:invoices,id'],
