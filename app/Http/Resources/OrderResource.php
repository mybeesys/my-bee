...
class OrderResource extends BaseResource
{
    ...
    public function toArray($request): array
    {
        return $this->filterFields([
            ...
            'discount' => number_format($this->discount, currency_decimals(), '.', ',') . " ". main_currency_native_symbol(),
            'delivery' => number_format($this->delivery, currency_decimals(), '.', ',') . " " . main_currency_native_symbol(),
            'extras' => number_format($this->resource->details->pluck('orderDetailsExtras')->flatten()->sum('unit_price'), currency_decimals(), '.', ',') . " " . main_currency_native_symbol(),
            'tax' => number_format($this->resource->details->sum('tax'), currency_decimals(), '.', ',') . " " . main_currency_native_symbol(),
            'total' => number_format($this->total, currency_decimals(), '.', ',') . " " . main_currency_native_symbol(),
