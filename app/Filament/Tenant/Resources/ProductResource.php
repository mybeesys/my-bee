...
//            RelationManagers\CostsRelationManager::class,
    ...
    {
        return parent::getEloquentQuery()->with(['category', 'media', 'allStocks', 'extras.prices', 'extras.lastPrice', 'lastPrice', 'prices', 'stocks', 'invoiceItems.invoice.customer'])->latest();
    }
