                    ...
                    $layout::make()
                        ->schema([
                            Forms\Components\Select::make('roles')
                                ...
                                ->required()
                                ->multiple()
                                ->options((new RoleService())->listForTenant())
                                ->searchable(),
                        ])
                        ->columns(1),
...
//                                ->disabled(1),
                ...
                Tables\Filters\Filter::make('roles')
                    ->form([
                        Forms\Components\Select::make('role')
                            ->label(__('fields.roles_permissions'))
                            ->multiple()
                            ->options(RoleService::instance()->listForTenant()),

                        Forms\Components\Checkbox::make('missing_roles')
                            ->label(__('fields.missing_roles'))
                            ->default(0),
                    ])
    ...
    {
        return parent::getEloquentQuery()->with(['roles', 'media'])->latest();
    }
