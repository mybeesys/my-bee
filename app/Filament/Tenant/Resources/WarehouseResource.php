        ...
        return $form
            ->schema([
                Forms\Components\Section::make(__('fields.warehouse'))
                    ->description(__('fields.warehouse_form_hint'))
                    ->columnSpanFull()
                    ->extraAttributes(['class' => 'warehouse-form-section'])
                    ->schema([
                        hidden_tenant_id_field(),

                        Forms\Components\TextInput::make('name')
                            ->label(__('fields.name'))
                            ->placeholder(__('fields.warehouse_name_placeholder'))
                            ->autofocus()
                            ->columnSpanFull()
...
//            RelationManagers\UnitsProductStockRelationManager::class,
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create-redirect' => Pages\RedirectWarehouseCreate::route('/create'),
