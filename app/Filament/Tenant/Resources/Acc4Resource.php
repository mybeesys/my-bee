<?php
    ...
    class Acc4Resource extends Resource
    {
        ...
        protected static ?string $slug = "finance/accounts-tree/level-four";
        ...
        {
            return parent::getEloquentQuery()->with(['acc3Code'])->latest(); // TODO: Change the autogenerated stub
        }
