...
class TreasuryAccountReportResource extends Resource
{
    ...
    {
        return __('fields.treasury_report');
    }
...
//            ->latest();
        ...
        return parent::getEloquentQuery()->with(['account', 'operation', 'account.acc3', 'currency', 'invoice'])
            ...
            ->whereRelation('account', 'item_type', null) // treasury (not customer not supplier)
            ->orderByDesc('id');
    }
    ...
    {
        return [
            'index' => Pages\ListTreasuryAccountReports::route('/'),
            'create' => Pages\CreateTreasuryAccountReport::route('/create'),
            'edit' => Pages\EditTreasuryAccountReport::route('/{record}/edit'),
        ];
    }
